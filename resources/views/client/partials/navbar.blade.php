{{-- @include('client.partials.nav') //This is supposed to be here at the end of the whole shenanigans--}}
        {{-- Navbar --}}
        <!--NAVBAR-->
        <!--===================================================-->
        <header id="navbar">
            <div id="navbar-container" class="boxed">
                ...
                <div class="navbar-header">
                    <a href="/clientdashboard" class="navbar-brand">
                        <img src="{{asset('img/logo.png')}}" alt="Nifty Logo" class="brand-icon">
                        <div class="brand-title">
                            <span class="brand-text">CuChip</span>
                        </div>
                    </a>
                </div>
                <!--================================-->
